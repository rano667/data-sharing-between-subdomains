...
This Poc allows sharing data between subdomains. So, that Multiple application's deployed in different subdomains can use the authentication token. Example: google search, gmail, google photos share token within application to authenticate a user. 
